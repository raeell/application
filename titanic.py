"""Script for titanic application."""
...
fig2_pclass = sns.barplot(data=TrainingData, x="Pclass", y="Survived", ax=axes[1]).set_title(
    "survie des Pclass"
)
...
# On _split_ notre _dataset_ d'apprentissage pour faire de la validation croisée
...
# calculons le score sur le dataset d'apprentissage
# et sur le dataset de test (10% du dataset d'apprentissage mis de côté)
